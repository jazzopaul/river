...
func TestSampleService(t *testing.T) {
	...
	setup := func(t *testing.T) (*sampleService, *testBundle) {
		t.Helper()
...
func TestWaitAllStarted(t *testing.T) {
	...
	t.Run("WaitsForStart", func(t *testing.T) {
		...
		WaitAllStarted([]Service{service1, service2, service3})
...
func TestWaitAllStartedC(t *testing.T) {
	...
	t.Run("WaitsForStart", func(t *testing.T) {
		...
		riverinternaltest.WaitOrTimeout(t, WaitAllStartedC([]Service{service1, service2, service3}))
